...
const ICONES = {
  ...
  badge: "M12 15a4 4 0 1 0 0-8 4 4 0 0 0 0 8Z M8.5 14 7 21l5-2.5L17 21l-1.5-7",
...
const LIENS_NAV = [
  ...
  { href: "/analyste/profil", label: "Mon profil", icone: "user" as const, actif: true },
];

export default function PageProfilAnalyste() {
